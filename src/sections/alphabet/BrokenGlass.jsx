...
//   },
  // {
  //   category: "ز",
  //   words: ["بُز","روز","زور","زَرد","زیب","باز","پاز","زِبر","بازی","تیز","زیر","زَر","خَز","زو","زیبا","زِشت","زار","راز","رُز"],
  // },
  // {
  //   category: "ک",
  ...
  // {
  //   category: "ط",
  //   words:["طَبل","طِفل","خَط","طُوطی","طار","طاس","طوس","طور","مَطَب","طَرَب"],
  // },
  //   {
  //   category:"حرف ظ",
  //   words:  ["ظَرف","نَظَر","ناظِر","حافِظ","نِظام","مَظروف","ظاهِر","مَظلوم","نِظافَت","مُنَظَم"],
  // },
    {
    category: " غ",
    words: ["غَذا","باغ","غُرور","غُروب","غار","غَریب","غُرِش","غَضَب","باغدار","کَلاغ"],
  },
...
//   {
//   category: "خ",
//   words: ["خانه","خور","خورد","خوردن","خواب","خوابید","خاک","خاکی","خرس","خرگوش","خود","خودکار","خبر","خیابان","خیار","خنده","خندید","خسته","خنک","خوش","خوشی","خاله","خواهر","خرید","خریدن",],
// },
...
//   },
  // {
  //   category:"کلمات حرف ک",
  //   words: ["کِتاب","کوکَب","کَبک","کَبود","کَبِد","کَپَک","کودَک","کار"],
  // },
    // {
    // category:"کلمات حرف ل",
    // words: ["لاک","بالا","کالا","سالو","لوک","کِلاس","لِباس","لاک پُشت","سالاد",],
    // },
//       {
//   category:"حرف ح",
//   words: ["حال","حِس","حامِد","حُباب","حِساب","حَلال","حَراج","حَیات","حامی","ساحِل","سَحَر","مُحِب","مُحکَم","مَحال","باحال","بی‌حال","بی‌حِس"],
// },
